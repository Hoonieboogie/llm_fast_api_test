...
def get_rag_answer(query: str, persist_dir="app/vector_store_q_only", k=3, search_mode="similarity"):
...
if __name__ == "__main__":
    while True:
        q = input("질문: ")
        ans = get_rag_answer(q, persist_dir="app/vector_store_q_only", search_mode="similarity", k=3)
        print("최종 답변:")
        print(ans)
        print()
        print()
